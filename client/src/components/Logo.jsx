  ...
  return (
    <Link to="/" onClick={onClick} className="brand-logo" aria-label="BuildPrime Home">
      ...
      >
        ...
        <rect x="4" y="4" width="5.5" height="24" rx="1.2" fill="#1b4332" />

        {/* Upper Structural Loop (Warm Gold Roofline Beam) */}
        <path d="M11.5 4H19.5C22.5 4 25 6.5 25 9.5C25 12.5 22.5 15 19.5 15H11.5V4Z" fill="#d99b26" />
        <path d="M11.5 7.5H19C19.8 7.5 20.5 8.2 20.5 9C20.5 9.8 19.8 10.5 19 10.5H11.5V7.5Z" fill="#ffffff" />

        {/* Lower Structural Base Loop (Deep Green Foundation) */}
        <path d="M11.5 14.5H21.5C24.8 14.5 27.5 17.2 27.5 20.5C27.5 23.8 24.8 26.5 21.5 26.5H11.5V14.5Z" fill="#1b4332" />
        ...
        <rect x="4" y="13.5" width="7.5" height="3" fill="#d99b26" />
      </svg>
